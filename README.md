...
I've created a user interface that combines a stock chart displaying closing prices over a 100-day span (Fig 1, Fig 3) along with news articles corresponding to certain dates, like the day of the biggest drop in the stock's price (Fig 2, Fig 4) -- currently this is the only "special date" I have implemented.
